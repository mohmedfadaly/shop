      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="{{route('banks.index')}}" class="nav-link">
              <p class="text">البنوك</p>
            </a>
          </li>

          <li class="nav-item">
          <a href="{{route('trans.index')}}" class="nav-link">
              <p class="text">بيانات التحويل</p>
            </a>
          </li>

          <li class="nav-item">
          <a href="{{route('pms.index')}}" class="nav-link">
              <p class="text">رسائل المتاجر</p>
            </a>
          </li>

          <li class="nav-item">
          <a href="{{route('ums.index')}}" class="nav-link">
              <p class="text">رسائل الاعضاء</p>
            </a>
          </li>
         <li class="nav-item">
          <a href="{{ route('logout') }}"
