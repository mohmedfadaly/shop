...
<div class="card card-primary">
			...
			<form role="form" class="contact100-form validate-form"action="{{ route('users.update' , ['id' => $user]) }}" method="POST" enctype="multipart/form-data"> 
            @csrf
            @method('PUT')  
			...
			<div class="card-body">
				<div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputEmail1" value="{{$user->name}}" type="text" name="name" placeholder="الاسم">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">رقم الهاتف</label>
                    <input class="form-control" id="exampleInputEmail1"  value="{{$user->phone}}" type="text" name="phone" placeholder="الاسم">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">البريد الالكتروني</label>
                    <input class="form-control" id="exampleInputEmail1"  value="{{$user->email}}" type="email" name="email" placeholder="الاسم">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">الصورة الشخصية</label>
                    <input type="file" value="{{ $user->image }}" name="image" >
                    <img src="{{ url('uploads/user/'.$user->image) }}" width="400">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">العنوان</label>
                    <input type="text" id="pac-input" class="form-control" placeholder="  "  value="{{ $user->address }}" name="address">
                  </div>
...
function initAutocomplete() {
    ...
    infoWindow.setContent('<a href="#">{{ $user->name }}</a>');
